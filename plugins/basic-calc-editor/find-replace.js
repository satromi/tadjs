/**
 * 検索/置換ウィンドウ
 * basic-calc-editorの子ウィンドウとして動作
 * @module plugins/basic-calc-editor/find-replace
 * @license MIT
 * @author satromi
 * @version 1.0.0
 */

class CalcFindReplaceWindow {
    constructor() {
    ...
    init() {
        ...
        this.messageBus = new window.MessageBus({
            debug: false,
            pluginName: 'CalcFindReplaceWindow',
            mode: 'child'
        });
    ...
    sendFindRequest() {
        ...
        this.messageBus.send('calc-find-next', {
    ...
    sendReplaceRequest() {
        ...
        this.messageBus.send('calc-replace-next', {
            searchText: searchText,
    ...
    sendReplaceAllRequest() {
        ...
        this.messageBus.send('calc-replace-all', {
            searchText: searchText,
            replaceText: this.replaceInput.value,
            isRegex: this.regexCheckbox.checked,
            editorWindowId: this.editorWindowId
