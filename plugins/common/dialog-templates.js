 ...
 *
 * 仮身一覧プラグイン (virtual-object-list) と NET 仮身一覧プラグイン (netbtron-object-list) で
 * 100% 同一のテンプレートを共通化したもの。各プラグインでは index.html で本ファイルを読み込み、
 * 個別のダイアログテンプレート (テナント系等) は各プラグインの dialog-templates.js に残す。
 */
